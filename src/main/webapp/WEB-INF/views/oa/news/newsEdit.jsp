...
<body>
	...
	<form:form id="inputForm" action="${ctx}/oa/news/updatenews" method="post" class="form-horizontal">
		<fieldset>
			<legend><small>编辑消息</small></legend>
			<table border="1" >
			<tr> 
			...
			<tr>
                ...
                <script type="text/javascript" src="${ctx }/ueditor/ueditor.all.js"></script>
                 ...
                 var ue = UE.getEditor('container',
                		          {initialFrameHeight:360,initialFrameWidth:1000 ,
			...
			<tr>
			    <td>
					<button type="button" id="create">确认</button>
	            </td>
	 		</tr>
